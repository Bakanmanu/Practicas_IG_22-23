...
// tipos
typedef enum{CUBO, PIRAMIDE, OBJETO_PLY, ROTACION, CILINDRO, CONO, ESFERA, EXTRUSION, EXCAVADORA, PALA} _tipo_objeto;
...
switch (t_objeto){
	...
	case PIRAMIDE: piramide.draw(modo,1.0,0.0,0.0,5);break;
        ...
        case PALA: pala.draw(modo,1.0,0.0,0.0,5);break;
	}
